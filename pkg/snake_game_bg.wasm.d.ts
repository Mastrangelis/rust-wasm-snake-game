...
export function world_snake_head(a: number): number;
export function world_snake_length(a: number): number;
export function world_snake_tail(a: number): number;
...
export function world_set_snake_direction(a: number, b: number, c: number): void;
